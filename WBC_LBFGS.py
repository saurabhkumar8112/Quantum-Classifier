...
param=get_param(30,var=0.1) # uncomment/comment this for train/test 
losses=[]
losses_t=[]
accuracies_t=[]
accuracies=[]
...
print("Starting training for WBC")
...
with open("wbc_lbfgs.pickle",'wb') as pickle_file:
...
plt.savefig("Loss_lbfgs_wbc.png")
plt.show()